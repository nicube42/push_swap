...
FILES = $(PATH_SRC)push_swap.c $(PATH_SRC)misc.c $(PATH_SRC)small_stack.c $(PATH_SRC)linked_list.c $(PATH_SRC)instructions.c $(PATH_SRC)radix.c $(PATH_SRC)parsing.c $(PATH_SRC)parsing2.c
